 ...
 *************************************************************************/
/*********************************************************************
 * $Id: AS_CGB_cga.h,v 1.6 2007-07-18 15:19:55 brianwalenz Exp $
 *
 * Module: AS_CGB_cga.h
 *
...
void chunk_graph_analysis(const IntFragment_ID max_frag_iid,
                          Tfragment        frags[],
                          Tedge            edges[],
                          const BPTYPE     nbase_in_genome,
                          const int        recalibrate_global_arrival_rate,
                          const float      cgb_unique_cutoff, // The threshold A-statistic score for classifying a unitig as a u-unitig.
                          const float      global_fragment_arrival_rate,
                          const char      *bubble_boundaries_filename,
                          TChunkFrag chunkfrags[], // An segmented array of LIDs for the chunks.
