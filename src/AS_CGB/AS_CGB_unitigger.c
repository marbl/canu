 ...
 *************************************************************************/
static char CM_ID[] = "$Id: AS_CGB_unitigger.c,v 1.15 2007-04-28 08:46:21 brianwalenz Exp $";
/*********************************************************************
 *
...
main(int argc, char **argv) {
 ...
 again:
  ...
  main_fgb( argc, argv, gstate, heapva, rg);
  main_cgb( argc, argv, gstate, heapva, rg);
