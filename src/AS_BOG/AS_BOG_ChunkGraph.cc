...
/* RCS info
 * $Id: AS_BOG_ChunkGraph.cc,v 1.2 2005-11-01 18:44:58 kli1000 Exp $
 * $Revision: 1.2 $
*/

static char AS_BOG_CHUNK_GRAPH_CC_CM_ID[] = "$Id: AS_BOG_ChunkGraph.cc,v 1.2 2005-11-01 18:44:58 kli1000 Exp $";
