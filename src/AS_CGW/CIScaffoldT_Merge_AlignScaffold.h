...
typedef struct {
  ...
  Scaffold_Gap  *gaps;        //  gaps[i] for i in [0,num_gaps-1] is the description of the (i+1)'st inter-contig gap
  Scaffold_Tig  *ctgs;        //  ctgs[i] for i in [0,num_gaps] is the description of the (i+1)'st contig
} Scaffold;
