...
/* RCS info
 * $Id: AS_OVL_overlap_ca.c,v 1.1.1.1 2004-04-14 13:52:20 catmandew Exp $
 * $Revision: 1.1.1.1 $
*/

static char CM_ID[] = "$Id: AS_OVL_overlap_ca.c,v 1.1.1.1 2004-04-14 13:52:20 catmandew Exp $";
