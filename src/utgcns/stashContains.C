...
// Instead of stashing contained + ONT reads, flag them to be ignored in generating consensus
// This allows us to access them for realignment in findCoordinates
void
