 ...
 *
 *    src/AS_CNS/utgcnsfix.C
 *
 *  Modifications by:
 *
 *    Brian P. Walenz from 2011-NOV-29 to 2013-OCT-04
 *      are Copyright 2011-2013 J. Craig Venter Institute, and
 *      are subject to the GNU General Public License version 2
 *
 *    Brian P. Walenz from 2014-DEC-30 to 2015-MAR-06
