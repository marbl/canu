...
\title{runCA-OBT\\
{\small or, how to run the Celera Assembler with Overlap Based Trimming in 54 easy steps while standing on your head}}
...
There are four configurable error rates.  $utg \le ovl \le cns \le
cgw$.  Usually, $ovl = cns$.
...
For both Overlap Based Trimming and normal overlaps, expressed as a fraction error, $0.0 \le error \le 0.25$.
...
Error rate for consensus, expressed as a fraction error, $0.0 \le error \le 0.25$.
The default is 0.06 (6\% error).
\\

cgwErrorRate={\it float} &
Error rate for scaffolder, expressed as a fraction error, $0.0 \le error \le 0.25$.
