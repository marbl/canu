...
If true (1), {\tt gatekeeper} blindly trusts all input insert sizes.
If false (0), {\tt gatekeeper} will reset too large / too small standard
deviations to $0.1 * mean$.  Acceptable insert sizes are $0.1*mean <
std.dev. < \frac{1}{3}*mean$.  The default is to reset input insert sizes.
