...
## OBT noVector ver. 1.3
## CA ver. 3.30

## Files Required
##REQUIRED PREFIX.frg PREFIX.catmap
...
$CA_BIN/unitigger -c -P P -A 1 -d 1 -x 1 -z 10 -j 5 $GENOMELENGTH_L -U $BUBBLE -e $ERATE -f \
...
#> Generate QC report
cd $WORKDIR
$CA_BIN/caqc.pl $GENOMELENGTH_G -metrics -euid $PREFIX.asm > caqc.out 2>&1
