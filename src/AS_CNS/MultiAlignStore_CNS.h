...
MultiAlignStoreT *CreateMultiAlignStoreT(void);
void              DeleteMultiAlignStoreT(MultiAlignStoreT *multiAlignStore);
void              ClearMultiAlignStoreT(MultiAlignStoreT *multiAlignStore);
...
void              RemoveMultiAlignFromStore(MultiAlignStoreT *mas, int index);
