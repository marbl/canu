<a href="documentation/HiCanu_Draft_Cover.jpg"><img src="documentation/HiCanu_Draft_Cover_Small.jpg" align="right" title="Dark and Stormy until HiCanu sees the Light, a draft Genome Research cover image by Arang Rhie."></a>
...
>[!CAUTION]
>Canu has reached END OF LIFE.  **Do NOT use for new work.** It hasn't seen
active development since around 2021, and also hasn't been tuned or tested on
data more recent than that.  Unless you're assembling reads from that era,
use a more recent assembler, such as [Verkko](https://github.com/marbl/verkko) or
[Hifiasm](https://github.com/chhylp123/hifiasm).

*Dark and Stormy until HiCanu sees the Light*, a draft Genome Research cover image by [Arang Rhie](https://genomeinformatics.github.io/people/rhie/).
