...
#  Install binaries
#
binaries="mergeCounts mersInMerStreamFile terminate"
...
cp -fp util/1-configure.pl      $installdir/bin/util/
cp -fp util/2-search.pl         $installdir/bin/util/
cp -fp util/3-filter.pl         $installdir/bin/util/
cp -fp util/4-polish.pl         $installdir/bin/util/
cp -fp util/5-assemble.pl       $installdir/bin/util/
cp -fp util/run.pl              $installdir/bin/util/
cp -p ../scripts/scheduler.pm   $installdir/bin/util/
cp -p ../scripts/fasta.pm       $installdir/bin/util/
